...
class DCMotor(Node):
    def __init__(self):
        ...
        self.motor_input_sub = self.create_subscription(Float32, 'motor_input_u_ROSario', self.input_callback,10)
        self.motor_speed_pub = self.create_publisher(Float32, 'motor_speed_y_ROSario', 10)
